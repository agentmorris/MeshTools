...
#ifndef _mass_springs_GLOBALS_H_
#define _mass_springs_GLOBALS_H_

class Cmass_springsDlg;
class Cmass_springsApp;
...
SCOPE Cmass_springsDlg* g_main_dlg;
SCOPE Cmass_springsApp* g_main_app;
#endif
