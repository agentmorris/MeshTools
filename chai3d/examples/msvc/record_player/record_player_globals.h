...
#ifndef _record_player_GLOBALS_H_
#define _record_player_GLOBALS_H_

class Crecord_playerDlg;
class Crecord_playerApp;
...
SCOPE Crecord_playerDlg* g_main_dlg;
SCOPE Crecord_playerApp* g_main_app;
#endif
