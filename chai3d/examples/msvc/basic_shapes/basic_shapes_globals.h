...
#ifndef _basic_shapes_GLOBALS_H_
#define _basic_shapes_GLOBALS_H_

class Cbasic_shapesDlg;
class Cbasic_shapesApp;
...
SCOPE Cbasic_shapesDlg* g_main_dlg;
SCOPE Cbasic_shapesApp* g_main_app;
#endif
