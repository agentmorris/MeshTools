...
// positions of phantom i
static double posX[2];
static double posY[2];
static double posZ[2];

// velocity of phantom i
static double velX[2];
static double velY[2];
static double velZ[2];

// force written to phantom i
static double FX[2];
static double FY[2];
static double FZ[2];

// torques written to phantom i
static double TX[2];
static double TY[2];
static double TZ[2];

// rotation matrix for phantom 0 or 1
gstTransformMatrix mat0;
gstTransformMatrix mat1;

// status for switch on phantom i
int stylus_switch[2];


// general variables for a ghost scene
gstScene *scene;
gstSeparator *root;
gstPHANToM *myPhantom[2]; 
...
//=============================================================================
// callback for gstEffect. One for each phantom.
//=============================================================================
